...
-- Q1: Who is the senior most employee based on employee titl?
...
-- Q1: Write a query to return the email, first name, & Genre of all
-- Rock Music listener. Return your list ordered alphabetically by  email
-- starting with A.
...
-- Q3: Return all the track names tha have a song length longer than the average 
-- song length. Return the Name and Millisecond for each track. Order by the song 
...
-- return customer name, artist name and total spen.
